    ...
    try {
      ...
      if (!res.ok) {
        if (json.code === 'BLOB_STORAGE_ERROR') {
          toast.error('⚠️ Vercel Blob Storage setup required! Please add BLOB_READ_WRITE_TOKEN in Vercel environment variables. See VERCEL_BLOB_SETUP.md for details.');
